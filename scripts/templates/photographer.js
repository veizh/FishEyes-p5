export function photographerTemplate(data) {
    ...
    function getUserCardDOM() {
        ...
        article.setAttribute('aria-label',`Je suis ${name}et je viens de ${country + city}. la phrase qui me décris est: ${tagline} et mes tarifs sont : ${price + "€ par jour"}` )
        article.addEventListener("click",()=>{
             document.location.href=window.location.origin+'/photographer.html?name='+name+'&id='+id
        })
